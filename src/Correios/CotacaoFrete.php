...
class CotacaoFrete
{
    ...
    // const MAX_VOLUME = 1157625; // 105cm ^ 3 (max de largura, comprimento e altura)
     ...
     */
    const FORA_INTERVALO_MAX_UNICO = 2;
    ...
    public function foraDoIntervalo()
    {
        switch ($this->nVlAcaoForaIntervalo) {
            case self::FORA_INTERVALO_MAX_UNICO:
                $this->calculaValoresMaximos();
                break;
            case self::FORA_INTERVALO_MAX_PACOTES:
                $this->calculaMaximoPacotes();
                break;
            case self::FORA_INTERVALO_MEDIA:
                $this->calculaMedia();
                break;
        }
    }
    ...
    /**
     * Aceita valores de self::FORA_INTERVALO_*
     * @param int $acao
     */
    ...
    /**
     * Define se o calculo será feito com aviso de recebimento
     *
     * @param bool $avisorecebimento
     */
    public function setAvisoRecebimento($avisorecebimento)
    {
        $this->sCdAvisoRecebimento = (bool)$avisorecebimento;
    }

    /**
     * @param string $cdEmpresa
     */
    ...
    {
        $this->sCdMaoPropria = (bool)$maopropria;
    }
